<template>
  ...
  <div class="container-fluid">
    <a class="navbar-brand"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-signal" viewBox="0 0 16 16">
    ...
    <div class="collapse navbar-collapse"  id="navbarSupportedContent" >
        <ul class="navbar-nav me-auto mb-lg-0 d-flex text-end">
            <li class="nav-item ">
                <router-link class="nav-link active" aria-current="page" @click.native="closeMenu()" to="/">Home Page</router-link>
        </li>
            
        </ul>
     
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 d-flex text-end">
       
        <li class="nav-item">
          <a class="nav-link">Your Posts</a>
        </li>
        <li class="nav-item">
          <a class="nav-link">Liked Posts</a>
        </li>
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li id="account"><router-link @click.native="closeMenu()" class="dropdown-item" to="/about">Account</router-link></li>
            <li><a class="dropdown-item" href="#">Manage Posts</a></li>
            <li><a class="dropdown-item" href="#">Manage Liked Posts</a></li>
          </ul>
        </li>
